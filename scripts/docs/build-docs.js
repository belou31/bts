...
<h3>3.4 Renouvellements (flat, 1 ligne = 1 siège)</h3>
<pre><code>node -r dotenv/config scripts/03-season-management/import-renewers-flat.js data/subscribers_flat.csv 2025-2026 \\
  --venue=patinoire-blagnac dotenv_config_path=.env.int
# Attendu: "Imported &lt;n&gt; subscriber seat lines"
</code></pre>

<h3>3.5 Nouveaux abonnés (import batch)</h3>
<pre><code>node -r dotenv/config scripts/03-season-management/import-subscription-orders.js data/subscription_orders.csv \\
  --season=2025-2026 --venue=patinoire-blagnac \\
  dotenv_config_path=.env.int
# Dry-run par défaut ; ajouter --commit (et --sendEmails) pour appliquer.
</code></pre>

<h3>3.6 Provision des sièges N-1</h3>
...
<h3>3.7 Export des liens renew (groupes)</h3>
...
<h3>3.8 Envoi d’invitations (e-mail)</h3>
<pre><code># DRY-RUN
...
<h3>3.9 Clôturer la phase renew</h3>
...
<h3>3.10 Gestion manuelle des commandes</h3>
...
<h3>4.2 Blocage/libération de sièges – <code>data_references/csv/seats-hold-release.template.csv</code></h3>
...
<h3>4.4 Nouveaux abonnés (batch) – <code>data/subscribers-import.template.csv</code></h3>
<p><strong>En-têtes :</strong> <code>orderRef,payerEmail,payerFirstName,payerLastName,groupKey,subscriberEmail,subscriberFirstName,subscriberLastName,phone,seasonCode,venueSlug,seatId,zoneKey,tariffCode,priceEuro,installments,status,notes</code></p>
<pre><code>orderRef,payerEmail,payerFirstName,payerLastName,groupKey,subscriberEmail,subscriberFirstName,subscriberLastName,phone,seasonCode,venueSlug,seatId,zoneKey,tariffCode,priceEuro,installments,status,notes
ORD-0001,jane.doe@example.com,Jane,Doe,doe-family,jane.doe@example.com,Jane,Doe,0600000001,2025-2026,patinoire-blagnac,N1-A-101,N1,NORMAL,180,1,paid,Première commande lot 1
ORD-0001,jane.doe@example.com,Jane,Doe,doe-family,john.doe@example.com,John,Doe,0600000002,2025-2026,patinoire-blagnac,N1-A-102,N1,NORMAL,180,1,paid,
</code></pre>

<h3>4.5 Liens renew (export) – <code>renew-groups-*.csv</code></h3>
