 ...
 *
 * Usage:
 *   node scripts/00-initialization/customize-app.js --name="Club Name" [--short-name="BTS"]
...
function usage() {
  console.log(`Usage:
  node scripts/00-initialization/customize-app.js --name="Club Name"
...
metadata.notes = 'Generated by scripts/00-initialization/customize-app.js';
